...
data_chart3 = second_dataset.sort_values(by = ['Start', 'Number_hours'])    
...
def __main__():
    ...
    def function():
        ...
        ratio = function.count_num/ total_slots
    ...
    def second_data():
        ...
        for i in range(num_res):
            ...
            Start_Slot = second_df.iloc[i,0]
            Number_of_Slots = second_df.iloc[i,1]
            Res_ID = second_df.iloc[i,2]
                ...
                if df1.iloc[Cars,Start_Slot] == 0:
                    ...
                    if Success == True:
                        ...
                        pygame.draw.rect(screen,
                                            ...
                                            ((WIDTH* Number_of_Slots ) + (MARGIN * Number_of_Slots) - MARGIN ),
                                            HEIGHT])
                        screen.blit(font.render(str(Res_ID),True,(WHITE)),(((MARGIN + WIDTH) * car_slots + MARGIN)+200 ,(MARGIN + HEIGHT) * Cars + MARGIN))
                        pygame.time.delay(50)
                        pygame.display.update()    
            ...
            if Success == False:
                ...
                failure_count+=1
                            #print (Success) #No, I cannot Schedule this car
        ratio1 = (function.count_num + count_num1)/ total_slots                    
        print("Total number of people successfully scheduled:" , scheduled)
        print('Ratio of filled to non-filled slots:', (ratio1) )
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if state == True:
                    if input_rect1.collidepoint(mouse_pos):
                        ...
                        data_chart3.to_csv("algorithm1.csv")
